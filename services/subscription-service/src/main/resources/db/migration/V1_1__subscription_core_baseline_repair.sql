-- Repair migration for environments that were automatically baselined at Flyway version 1
-- before V1__subscription_core.sql could execute. All statements intentionally mirror the
-- idempotent V1 bootstrap so this migration is safe both after a version-1 baseline and after
-- a normal V1 execution.
