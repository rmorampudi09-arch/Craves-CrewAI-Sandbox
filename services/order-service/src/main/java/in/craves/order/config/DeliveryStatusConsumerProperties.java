...
@ConfigurationProperties(prefix = "craves.delivery-status-consumer")
public class DeliveryStatusConsumerProperties {
    private boolean enabled;
    private String fullyQualifiedNamespace = "";
    private String connectionString = "";
    private String topicName = "craves-domain-events";
    private String subscriptionName = "order-service-delivery-status-changed";
